...
This a progress project towards building a full web application that resemble Airbnb (clone). The part of the prject covers creating package, simple flow of (de)serialization: instance--> Dictionary --> JSON string --> file, storage engine and unittest to validate all the classes
